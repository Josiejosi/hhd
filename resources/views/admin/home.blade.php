	...
	<div class="row">
		...
		<div class="col-md-8 col-sm-8">
			...
			<ul class="nav nav-tabs">
				<li class="active">
					<a href="#small" data-toggle="tab" aria-expanded="false"> Small Dream </a>
				</li>
				<li class="">
					<a href="#big" data-toggle="tab" aria-expanded="true"> Big Dream </a>
				</li>
			</ul>
			...
			<div class="tab-content">
				...
				<div class="tab-pane fade active in" id="small">
					<div class="note note-info">
						<h4 class="block">Small Dream</h4>
						<p> Please select help from ZAR 1000 - ZAR 20 000</p>
					</div>
				...
				<div class="tab-pane fade active in" id="small">
					...
					<div class="note note-info">
						<h4 class="block">HELP TIME IS BETWEEN</h4>
		...
		<div class="col-md-12 col-sm-12">
			...
			<div class="portlet light bordered">
			    <div class="portlet-title tabbable-line">
			        ...
			        <ul class="nav nav-tabs">
			            <li class="active">
			                <a href="#tab_1_1" class="active" data-toggle="tab" aria-expanded="true"> Dreams </a>
			            </li>
			        </ul>
			    </div>
		                ...
		                <div class="col-md-4">
		                    <div class="easy-pie-chart">
		                        <div class="number transactions" data-percent="55">
		                            <span>53</span>% <canvas height="75" width="75"></canvas></div>
		    ...
		    onFinish: function (data) {
				...
				//event.preventDefault() 
				 ...
				 $("#assignment_div_big").html(
					...
					"Please be patient as we try and find a suitable match for your help request.<br />" +
