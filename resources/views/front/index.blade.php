        ...
        <div class="content-wrap">
		    ...
		    <div class="container clearfix">
		        ...
		        <div class="center-block less-width text-center clearfix">
		            ...
		            <h3>30% in 3days, everyday at 00:00</h3>
		            <a href="{{url('/login')}}" class="myBtn myBtn-3d myBtn-dark myBtn-lg ">Login</a>
		            <a href="{{url('/register')}}" class="myBtn myBtn-3d myBtn-lg">Register</a>
		        </div>
		            ...
		            <div class="row">
		                ...
		                <div class="col-md-6">
		                    ...
		                    <p class="lead text-ondark mb-60">
		                        We tried to make our system clean, no referrals, no lists, just a pool of money to work with, daily and get your 30% with the money you donated back.<br />
