...
class HomeController extends Controller
{
    ...
    public function get_donar( Request $request ) {
    	...
    	if ( $max_reserves_allowed == 'add' ) {
    		...
    		return "Sorry you already have $max_reserves_limit donations made today, please wait for approval from assigned members to create a new one." ;
    	}
    	...
    	if ( $max_reserves_allowed == "add" ) {
	    	...
	    	if ( count($active) == 1 ) {
		    	if ( $active->donation_status == 0 && $active->is_processed == 0 &&  $active->receiver != Auth::user()->id ) {
			    	...
			    	$sms_message 			= "
			    								You have successfully being assigned to donate, details are as follows, 
			    								Account Holder: ". $receiver_details->first_name . " " .$receiver_details->last_name .", 
			    								Holder's Cell Phone: " . $receiver_details->cell_phone . ", 
			    								Bank: ".$receiver_bank_details->bank.",
			    								Account Number: ".$receiver_bank_details->account_number." ,
			    								Branch Code: ".$receiver_bank_details->branch_code." ,
			    								Amount: R " .$receiver_amount . ".
			    							  " ;
			    	...
			    	$message 				= "Hi ".$receiver_details->first_name . " " .$receiver_details->last_name."
			    								<br /><br />
			    								".Auth::user()->first_name ." ".Auth::user()->last_name." was assigned to you for an amount of R ".$receiver_amount.", Please ensure you go to the online app to accept their Donation once the money reflects on your account.
			    								<strong>NOTE: Failure to accept payments will result in your account blocked for 3 months, if the Donor reports you for delaying acknowledgment of receiving payments</strong>
			    								<br /><br />
			    								Warm Regards,<br />
			    								PrestigeWallet.com
			    							  " ;

			    	$sms_message 			= "Hi ".$receiver_details->first_name . " " .$receiver_details->last_name.",  
			    							  ".Auth::user()->first_name ." ".Auth::user()->last_name." was assigned to you for an amount of R ".$receiver_amount.", ".
			    							  "Please ensure you go to the online app to accept their Donation once the money reflects on your account." ;
    		...
    		return "Sorry you already have reached your daily donation limit of$max_reserves_limit, please wait for approval from assigned members to create a new one." ;
    	}
